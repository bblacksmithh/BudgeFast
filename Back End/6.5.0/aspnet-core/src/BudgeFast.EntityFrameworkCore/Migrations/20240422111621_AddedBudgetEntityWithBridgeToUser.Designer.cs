...
namespace BudgeFast.Migrations
{
    ...
    [Migration("20240422111621_AddedBudgetEntityWithBridgeToUser")]
    partial class AddedBudgetEntityWithBridgeToUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgeFast.Domains.BankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BudgeFast.Domains.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BudgeFast.Domains.Statement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BudgeFast.Domains.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BudgeFast.Domains.TransactionCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("BudgeFast.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("BudgeFast.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("BudgeFast.Domains.Liability", b =>
                {
                    b.HasOne("BudgeFast.Domains.BankAccount", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("BudgeFast.Domains.Statement", b =>
                {
                    b.HasOne("BudgeFast.Domains.BankAccount", "BankAccount")
                        .WithMany()
