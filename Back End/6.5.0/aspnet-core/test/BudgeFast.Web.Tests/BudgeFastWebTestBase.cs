...
namespace BudgeFast.Web.Tests
{
    public abstract class BudgeFastWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BudgeFastWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BudgeFastWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BudgeFastDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BudgeFastDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BudgeFastDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BudgeFastDbContext, Task<T>> func)
        {
            T result;
